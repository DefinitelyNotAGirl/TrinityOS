...
build/FUNCDIS/%.o: modules/FUNCDIS/src/%.cpp
	@g++ -O0 -fno-rtti -fno-exceptions -nostdlib -ffreestanding -fno-stack-protector -fno-builtin -nostartfiles -Wunreachable-code -std=c++20 -w -Wno-literal-suffix -Wno-pointer-arith -MP -MD -Imodules/klib/inc/ -Iinc/ -Ishared/ -Imodules/FUNCDIS/inc -march=x86-64 -c -o $@ $<
	$(info 	[35m[COMPILE][0m	$<)
...
build/FUNCDIS/%.o: modules/FUNCDIS/src/%.c
	...
	$(info  	[35m[COMPILE][0m	$<)
m-FUNCDIS-clean:
	@-rm -r build/FUNCDIS/*.o > /dev/null
	$(info  	[33m[CLEAN][0m	build/FUNCDIS/*.o)
	@-rm -r build/FUNCDIS/*.d > /dev/null
	$(info  	[33m[CLEAN][0m	build/FUNCDIS/*.d)
...
out/kernel/FUNCDIS.elf64:  $(FUNCDIS_OBJECTS_asm_asm) $(FUNCDIS_OBJECTS_asm_s) $(FUNCDIS_OBJECTS_cpp_cpp) $(FUNCDIS_OBJECTS_cpp_cxx) $(FUNCDIS_OBJECTS_c_c)
	@ld -nostdlib -w -T LDS/FUNCDIS.ld  $(FUNCDIS_OBJECTS_asm_asm) $(FUNCDIS_OBJECTS_asm_s) $(FUNCDIS_OBJECTS_cpp_cpp) $(FUNCDIS_OBJECTS_cpp_cxx) $(FUNCDIS_OBJECTS_c_c)  $(klib_OBJECTS_asm_asm) $(klib_OBJECTS_asm_s) $(klib_OBJECTS_cpp_cpp) $(klib_OBJECTS_cpp_cxx) $(klib_OBJECTS_c_c) -o out/kernel/FUNCDIS.elf64
	$(info  	[34m[LINK][0m	$@)
	@objcopy out/kernel/FUNCDIS.elf64  --remove-section text_klib --remove-section rodata_klib --remove-section data_klib --remove-section bss_klib &> /dev/null
